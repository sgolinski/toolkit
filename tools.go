...
// RandomString returns a string of random characters of legth n using randomStringSource
...
// UploadedFile Uploaded file is a struct used to save infromation about uploaded file
...
// CreateDirIfNotExists creates directory and all necessary parents if it does not exist
...
//in the browser window by seting content dispositions It also allows specification of the
//display name
...
// PushJSONToRemote posts arbitrary data to some URL as JSON and returns the reposnse, status xcodde and error if any
// The final parameter, client, is optional. If none iss specified, we sue the standard http.Client
